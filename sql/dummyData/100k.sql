...
SELECT CONCAT('First Name ', FLOOR(1 + RANDOM() * 100000)), CONCAT('Last Name ', FLOOR(1 + RANDOM() * 100000)), CONCAT('email ', FLOOR(1 + RANDOM() * 100000)), CONCAT('password ', FLOOR(1 + RANDOM() * 100000)), CONCAT('age ', FLOOR(15 + RANDOM() * 30))
FROM generate_series(1, 100000) AS id;


INSERT INTO posts(title, body)
SELECT CONCAT('Title ', FLOOR(1 + RANDOM() * 100000)), CONCAT('Body ', FLOOR(1 + RANDOM() * 100000))
FROM generate_series(1, 100000) AS id;
...
SELECT CONCAT('Body ', FLOOR(1 + RANDOM() * 100000))
FROM generate_series(1, 100000) AS id;

INSERT INTO user_comments(user_id, post_id, comment_id)
SELECT FLOOR(1 + RANDOM() * 100000), FLOOR(1 + RANDOM() * 100000),FLOOR(1 + RANDOM() * 100000)
FROM generate_series(1, 100000) AS id;
