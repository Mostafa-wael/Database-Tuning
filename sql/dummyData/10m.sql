...
SELECT CONCAT('First Name ', FLOOR(1 + RANDOM() * 10000000)), CONCAT('Last Name ', FLOOR(1 + RANDOM() * 10000000)), CONCAT('email ', FLOOR(1 + RANDOM() * 10000000)), CONCAT('password ', FLOOR(1 + RANDOM() * 10000000)), CONCAT('age ', FLOOR(15 + RANDOM() * 30))
