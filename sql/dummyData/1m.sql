...
SELECT CONCAT('First Name ', FLOOR(1 + RANDOM() * 1000)), CONCAT('Last Name ', FLOOR(1 + RANDOM() * 1000)), CONCAT('email ', FLOOR(1 + RANDOM() * 1000)), CONCAT('password ', FLOOR(1 + RANDOM() * 1000)), FLOOR(15 + RANDOM() * 30) , CONCAT('city ', FLOOR(1 + RANDOM() * 1000))
FROM generate_series(1, 1000000) AS id;


INSERT INTO posts(title, body)
SELECT CONCAT('Title ', FLOOR(1 + RANDOM() * 1000)), CONCAT('Body ', FLOOR(1 + RANDOM() * 10000))
FROM generate_series(1, 1000000) AS id;
...
SELECT CONCAT('Body ', FLOOR(1 + RANDOM() * 1000))
FROM generate_series(1, 1000000) AS id;

INSERT INTO user_comments(user_id, post_id, comment_id)
SELECT FLOOR(1 + RANDOM() * 1000), FLOOR(1 + RANDOM() * 1000),FLOOR(1 + RANDOM() * 10000)
FROM generate_series(1, 1000000) AS id;
...
SELECT FLOOR(1 + RANDOM() * 1000), FLOOR(1 + RANDOM() * 1000), CONCAT('Body ', FLOOR(1 + RANDOM() * 100))
FROM generate_series(1, 1000000) AS id;
...
INSERT INTO users(first_name, last_name, email, password,age, city)
SELECT CONCAT('First Name ', FLOOR(1 + RANDOM() * 1000)), CONCAT('Last Name ', FLOOR(1 + RANDOM() * 1000)), CONCAT('email ', FLOOR(1 + RANDOM() * 1000)), CONCAT('password ', FLOOR(1 + RANDOM() * 1000)), FLOOR(15 + RANDOM() * 30) , CONCAT('city ', 'Cairo')
FROM generate_series(1, 1000) AS id;

-- 1000 users with Giza as city
INSERT INTO users(first_name, last_name, email, password,age, city)
SELECT CONCAT('First Name ', FLOOR(1 + RANDOM() * 1000)), CONCAT('Last Name ', FLOOR(1 + RANDOM() * 1000)), CONCAT('email ', FLOOR(1 + RANDOM() * 1000)), CONCAT('password ', FLOOR(1 + RANDOM() * 1000)), FLOOR(15 + RANDOM() * 30) , CONCAT('city ', 'Giza')
FROM generate_series(1, 1000) AS id;
