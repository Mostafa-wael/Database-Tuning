...
SELECT CONCAT('First Name ', FLOOR(1 + RANDOM() * 10000)), CONCAT('Last Name ', FLOOR(1 + RANDOM() * 10000)), CONCAT('email ', FLOOR(1 + RANDOM() * 10000)), CONCAT('password ', FLOOR(1 + RANDOM() * 10000))
