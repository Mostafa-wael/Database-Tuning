...
CREATE TABLE user_comments (
  ...
  CONSTRAINT user_comments_ibfk_4 FOREIGN KEY (user_id, post_id) REFERENCES user_posts (user_id, post_id)
...
CREATE TABLE likes (
  ...
  CONSTRAINT likes_ibfk_3 FOREIGN KEY (user_id, post_id) REFERENCES user_posts (user_id, post_id)
